...
<div class="dashboard container">
    ...
    <aside class="col-md-3 nav-sticky dashboard-sidebar">
        ...
        <div class="user-info text-center p-3">
            <img src="{{ asset(Auth::guard('web')->user()->img_path) }}" alt="User Image" class="rounded-circle mb-2"
    ...
    <div class="main-content">
        ...
        <section id="profile" class="content-section active">
            ...
            <div class="user-profile mb-3">
                <img src="{{ asset(Auth::guard('web')->user()->img_path) }}" alt="User Image" class="profile-img rounded-circle"
            ...
            <section id="add-post" class="add-post-section mb-5">
                ...
                <div class="post-form p-3 border rounded">
                    ...
                    <label class="label">
                        ...
                        Enable Comments: <input type="checkbox" class="" />
                    </label><br>
                ...
                <div class="post-list">
                    ...
                    <div class="post-item mb-4 p-3 border rounded">
                        <div class="post-header d-flex align-items-center mb-2">
                            <img src="{{ asset('UserImage.jpg') }}" alt="User Image" class="rounded-circle"
                        ...
                        <div id="newsCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item  active">
                                    <img src="{{ asset('UserImage.jpg') }}" class="d-block w-100" alt="First Slide">
                        ...
                        <div class="comments">
                            <div class="comment">
                                <img src="{{ asset('UserImage.jpg') }}" alt="User Image" class="comment-img" />
